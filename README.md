...
* **Orthoformer (Function-centric Microbial Foundation Model):** As co-first author and the primary developer/trainer of the foundation-model framework, I led the architecture implementation and large-scale pretraining of **Orthoformer** on ~3 million prokaryotic and viral genomes using orthologous-group composition and abundance as the functional vocabulary. The model establishes a function-first embedding space for alignment-free taxonomy/phylogeny, ANI-consistent genomic similarity, metabolic capacity prediction (including BGC abundance), ecological niche discrimination, and organism-level phenotype/marker-gene discovery. Project: [Orthoformer](https://github.com/JackKuo666/Orthoformer). (Manuscript under review at **Nature Communications**)
